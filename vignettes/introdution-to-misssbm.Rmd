...
library(blockmodels)
mod=BM_bernoulli("SBM_sym",as.matrix(get.adjacency(war_graphs$beligerent)),verbosity=0)
mod$estimate()
mod=BM_bernoulli("SBM",as.matrix(get.adjacency(war_graphs$beligerent)),verbosity=0)
mod$estimate()
```
