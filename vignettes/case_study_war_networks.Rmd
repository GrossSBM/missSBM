...
```{r sampling node}
partiallyObservedNet_war <- missSBM::sample(belligerent_adjacency, sampling = "node", parameters = .8)
corrplot(partiallyObservedNet_war, 
  is.corr      = FALSE,
  tl.pos       = "n",
  method       = "color", 
  cl.pos       = "n",
...
vBlocks <- 1:5
collection_sbm <- missSBM::estimate(partiallyObservedNet_war, vBlocks = vBlocks, sampling = "node")
