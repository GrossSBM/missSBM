...
Rcpp::NumericMatrix M_step_sparse_bernoulli_undirected_nocovariate(const arma::sp_mat& Y, const arma::sp_mat& R, const arma::mat& Z);
...
Rcpp::NumericMatrix M_step_sparse_bernoulli_directed_nocovariate(const arma::sp_mat& Y, const arma::sp_mat& R, const arma::mat& Z);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const arma::sp_mat& >::type R(RSEXP);
    Rcpp::traits::input_parameter< const arma::mat& >::type Z(ZSEXP);
    rcpp_result_gen = Rcpp::wrap(M_step_sparse_bernoulli_directed_covariates(Y, R, Z));
    return rcpp_result_gen;
END_RCPP
}
