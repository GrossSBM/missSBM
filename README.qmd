...
See `vignette("case_study_war_networks")` and [the JSS article](https://doi.org/10.18637/jss.v101.i12) for a more comprehensive tour, including covariates and further sampling designs.
